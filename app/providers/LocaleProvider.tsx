...
const messages: Record<LocaleCode, Record<string, string>> = {
  th: {
    ...
    terms_cancel_condition: "ยกเลิกได้เฉพาะกรณีที่ยังไม่มีการอนุมัติหรือปฏิเสธ",
  ...
  en: {
    ...
    terms_cancel_condition: "Only if not yet approved or rejected",
  ...
  my: {
    ...
    terms_cancel_condition: "အတည်ပြုခြင်း သို့မဟုတ် ပယ်ချခြင်း မရှိသေးမှသာ",
