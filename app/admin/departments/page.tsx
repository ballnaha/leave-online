...
export default function DepartmentsPage() {
  ...
  const handleSave = () => {
    setDialogOpen(false);
    toastr.success(selectedDepartment ? 'แก้ไขแผนกสำเร็จ' : 'เพิ่มแผนกสำเร็จ');
    fetchDepartments();
  };
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ bgcolor: alpha(theme.palette.primary.main, 0.04) }}>
                ...
                <TableCell sx={{ fontWeight: 600, color: 'text.secondary', py: 2 }}>หน่วยงาน</TableCell>
              ...
              <TableBody>
                {paginatedDepartments.map((department) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Chip
                        label={`${department._count?.sections || 0} หน่วยงาน`}
                        size="small"
                        sx={{ 
