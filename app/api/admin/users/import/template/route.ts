...
export async function GET() {
    try {
        ...
        const demoData = [
            ...
            [],
            ['คำอธิบาย:'],
            ['- รหัสฝ่าย: ใส่รหัสฝ่ายในคอลัมน์ "ชื่อ" (ดูจากเมนูตั้งค่าฝ่าย)'],
            ['- รหัสแผนก: ใส่รหัสแผนกในคอลัมน์ "ชื่อ" (ดูจากเมนูตั้งค่าแผนก)'],
            ['- พนักงาน: รหัสพนักงาน เว้้นวรรค ตามด้วย ชื่อ-นามสกุล'],
            ['- วันที่เข้างาน: รูปแบบ วัน/เดือน/ปี (พ.ศ.)'],
            [''],
            ['หมายเหตุ:'],
            ['- ระบบจะดึงรหัสฝ่าย และ รหัสแผนก ล่าสุดที่อยู่ด้านบนมาใส่ให้พนักงานอัตโนมัติ'],
